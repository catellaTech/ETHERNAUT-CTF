...
With the only catch that the first time it has to return false to enter the 
if (!building.isLastFloor(_floor)) {} and the second time it has to return true to satisfy 
